...
class GXEDB:
    ...
    The :class:`geosoft.gxapi.GXEDB` class provides access to a database as displayed within
    ...
    **Note:**
    ...
    to begin with an :class:`geosoft.gxapi.GXEDB` object, and use the Lock_EDB function to
    lock the underlying map to prevent external changes. The returned
    :class:`geosoft.gxapi.GXDB` object (see :class:`geosoft.gxapi.GXDB`) may then be safely used to make changes to the map itself.
    """
    ...
    def is_null(self):
        ...
        :returns: True if this is a null (undefined) instance of :class:`geosoft.gxapi.GXEDB`, False otherwise.
        """
...
# Miscellaneous
    ...
    def destroy_view(self, p2):
        ...
        **Note:**
        ...
        :class:`geosoft.gxapi.GXEDB` object will become invalid. If this is the last view on
    ...
    def get_profile_split_vv(self, p2):
        ...
        **Note:**
        ...
        The returned :class:`geosoft.gxapi.GXVV` is sized to the maximum number of profiles
    ...
    def all_chan_list(self, p2):
        ...
        **Note:**
        ...
        The :class:`geosoft.gxapi.GXVV` elements must be INT.
    ...
    def get_databases_lst(cls, p1, p2):
        """
        Load the file names of open databases into a :class:`geosoft.gxapi.GXLST`.
        """
    ...
    def get_mark_chan_vv(self, p2, p3):
        ...
        **Note:**
        ...
        The :class:`geosoft.gxapi.GXVV` will be resized to the length of the data
        """
    ...
    def get_mark_chan_va(self, p2, p3):
        ...
        **Note:**
        ...
        The :class:`geosoft.gxapi.GXVA` will be resized to the length of the data
        """
    ...
    def get_name(self, p2):
        """
        Get the name of the database object of this :class:`geosoft.gxapi.GXEDB`.
        """
    ...
    def load_with_view(cls, p1, p2):
        """
        Load an :class:`geosoft.gxapi.GXEDB` with the view from a current :class:`geosoft.gxapi.GXEDB`.
    ...
    def make_current(self):
        """
        Makes this :class:`geosoft.gxapi.GXEDB` object the current active object to the user.
        """
    ...
    def set_profile_split_vv(self, p2):
        ...
        **Note:**
        ...
        The input :class:`geosoft.gxapi.GXVV` values are the fractional heights for each
        profile window. Values are summed, and normalized (so you can
        enter "1,1,1", with a :class:`geosoft.gxapi.GXVV` of length 3, if you want 3 equal profile windows).
        
        :class:`geosoft.gxapi.GXVV` values beyond the maximum number of displayable
        profiles (:attr:`geosoft.gxapi.MAX_PROF_WND`) are ignored.
        """
    ...
    def statistics(self, p2):
        """
        Add all currently selected data to the :class:`geosoft.gxapi.GXST`.
    ...
    def un_load_verify(cls, p1, p2):
        ...
        **Note:**
        ...
        If :attr:`geosoft.gxapi.EDB_UNLOAD_NO_PROMPT`, data is always saved.
        EDB_UNLOAD_MULTIPROMPT is now obsolete and
        is equivalent to :attr:`geosoft.gxapi.EDB_UNLOAD_SINGLE_PROMPT`.
        """
