...
class GXFFT2:
    ...
    These methods now work with an :class:`geosoft.gxapi.GXIMG` object, instead of creating
    their own :class:`geosoft.gxapi.GXFFT2` object.
    """
    ...
    def null(cls):
        """
        A null (undefined) instance of :class:`geosoft.gxapi.GXFFT2`
        
        :returns: A null :class:`geosoft.gxapi.GXFFT2`
        """
        return cls()

    def is_null(self):
        """
        Check if the instance of :class:`geosoft.gxapi.GXFFT2` is null (undefined)`
        
        :returns: True if this is a null (undefined) instance of :class:`geosoft.gxapi.GXFFT2`, False otherwise.
        """
...
# Miscellaneous
    ...
    def fft2_in(cls, p1, p2, p3):
        """
        :class:`geosoft.gxapi.GXFFT2` transform
        """
    ...
    def filter_pg(cls, p1, p2, p3, p4, p5, p6):
        """
        Apply 2D :class:`geosoft.gxapi.GXFFT` filters to data in pager
        """
    ...
    def flt(cls, p1, p2, p3):
        """
        :class:`geosoft.gxapi.GXFFT2` filter
        """
    ...
    def flt_inv(cls, p1, p2, p3):
        """
        :class:`geosoft.gxapi.GXFFT2` filter and inverse
        """
    ...
    def pow_spc(cls, p1, p2):
        """
        :class:`geosoft.gxapi.GXFFT2` transform power spectrum
        """
    ...
    def rad_spc(cls, p1, p2):
        """
        :class:`geosoft.gxapi.GXFFT2` transform Radially averaged power spectrum
        """
    ...
    def rad_spc1(cls, p1, p2):
        """
        :class:`geosoft.gxapi.GXFFT2` transform Radially averaged power spectrum for one :class:`geosoft.gxapi.GXIMG`
        """
    ...
    def rad_spc2(cls, p1, p2, p3, p4, p5):
        """
        :class:`geosoft.gxapi.GXFFT2` transform Radially averaged power spectrum for two IMGs
        """
    ...
    def td_xd_y(cls, p1, p2, p3, p4):
        """
        :class:`geosoft.gxapi.GXFFT2` filter (calculate T from the derivatives Tx and Ty)
        """
    ...
    def trans_pg(cls, p1, p2):
        """
        Apply 2D :class:`geosoft.gxapi.GXFFT` transform to data in pager
        """
