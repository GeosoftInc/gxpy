...
# General
    ...
    def direct_gridding_dat(cls, pg, xo, yo, dx, dy, rot, dat, method):
        ...
        **Note:** Grid cells take on the specified statistic of the values inside the
        ...
        """
        gxapi_cy.WrapPGU._direct_gridding_dat(GXContext._get_tls_geo(), pg, xo, yo, dx, dy, rot, dat, method)
    ...
    def direct_gridding_dat_3d(cls, pg, xo, yo, zo, dx, dy, dz, rot, dat, method):
        ...
        **Note:** 3D grid cells take on the specified statistic of the values inside the
        cell area. Grid cells containing no data values are set to dummy.
        """
        gxapi_cy.WrapPGU._direct_gridding_dat_3d(GXContext._get_tls_geo(), pg, xo, yo, zo, dx, dy, dz, rot, dat, method)
