...
# Miscellaneous
    ...
    def create(cls, p1: str, p2: 'GXIPJ') -> 'GXSURFACE':
        ret_val = gxapi_cy.WrapSURFACE.create(GXContext._get_tls_geo(), p2)
    ...
    def open(cls, p1: str, p2: int) -> 'GXSURFACE':
        ret_val = gxapi_cy.WrapSURFACE.open(GXContext._get_tls_geo(), p2)
        return GXSURFACE(ret_val)
    ...
    def get_surface_items(self, p2: 'GXLST') -> None:
        self._wrapper.get_surface_items(p2)
    ...
    def add_surface_item(self, p2: 'GXSURFACEITEM') -> None:
        self._wrapper.add_surface_item(p2)
    ...
    def get_surface_names(cls, p1: str, p2: 'GXLST') -> None:
        gxapi_cy.WrapSURFACE.get_surface_names(GXContext._get_tls_geo(), p2)
    ...
    def get_closed_surface_names(cls, p1: str, p2: 'GXLST') -> None:
        gxapi_cy.WrapSURFACE.get_closed_surface_names(GXContext._get_tls_geo(), p2)
    ...
    def crc(cls, p1: str, p2: str, p3: int_ref) -> int:
        ret_val, p3.value = gxapi_cy.WrapSURFACE.crc(GXContext._get_tls_geo(), p2.encode(), p3.value)
        return ret_val
    ...
    def sync(cls, p1: str) -> None:
        gxapi_cy.WrapSURFACE.sync(GXContext._get_tls_geo())
    ...
    def create_from_dxf(cls, p1: 'GXIPJ', p2: str, p3: str) -> None:
        gxapi_cy.WrapSURFACE.create_from_dxf(GXContext._get_tls_geo(), p2.encode(), p3.encode())
    ...
    def create_from_vulcan_triangulation(cls, p1: str, p2: 'GXIPJ', p3: str) -> None:
        gxapi_cy.WrapSURFACE.create_from_vulcan_triangulation(GXContext._get_tls_geo(), p2, p3.encode())
    ...
    def append_vulcan_triangulation(cls, p1: str, p2: 'GXIPJ', p3: str) -> None:
        gxapi_cy.WrapSURFACE.append_vulcan_triangulation(GXContext._get_tls_geo(), p2, p3.encode())
