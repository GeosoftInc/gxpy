...
class GXKGRD:
    ...
    The :class:`geosoft.gxapi.GXKGRD` object is used as a storage place for the control
    parameters that the Krigrid program needs to execute. The
    Run_KGRD function executes the Krigrid program using the
    :class:`geosoft.gxapi.GXKGRD` object.
    """
    ...
    def is_null(self):
        ...
        :returns: True if this is a null (undefined) instance of :class:`geosoft.gxapi.GXKGRD`, False otherwise.
        """
...
# Miscellaneous
    ...
    def clear(self):
        """
        Clears all the parameters in a :class:`geosoft.gxapi.GXKGRD` object
        """
        self._wrapper.clear()
    ...
    def create(cls):
        ...
        **Note:**
        ...
        control file parameters into the :class:`geosoft.gxapi.GXKGRD` object.
        """
    ...
    def load_parms(self, p2):
        ...
        **Note:**
        ...
        file will be generated and put into the :class:`geosoft.gxapi.GXKGRD` object.
        Otherwise, the control file's settings are retrieved from
        the file and loaded into the :class:`geosoft.gxapi.GXKGRD` object.
        """
